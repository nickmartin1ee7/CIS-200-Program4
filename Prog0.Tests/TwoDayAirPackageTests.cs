...
namespace Prog0.Tests
{
    public class TwoDayAirPackageTests
    {
        ...
        [TestCase(0, 0, 0, -1, 0)]
        [TestCase(0, 0, 0, 0, -1)]
        public void Ctor_ShouldThrow_WhenPassedNegativeArguments(double length, double width, double height, double weight, TwoDayAirPackage.Delivery deliveryType)
        {
        ...
        public void CalcCost_ShouldCalculate(double length, double width, double height, double weight, TwoDayAirPackage.Delivery deliveryType, decimal cost)
        {
