...
namespace Prog0.Tests
{
    public class NextDayAirPackageTests
    {
        ...
        [TestCase(0, 0, 0, -1, 0)]
        [TestCase(0, 0, 0, 0, -1)]
        public void Ctor_ShouldThrow_WhenPassedNegativeArguments(double length, double width, double height, double weight, decimal expressFee)
        {
        ...
        public void CalcCost_ShouldCalculate(double length, double width, double height, double weight, decimal expressFee, decimal cost)
        {
